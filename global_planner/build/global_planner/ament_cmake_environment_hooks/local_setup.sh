...
: ${AMENT_CURRENT_PREFIX:="/home/misys/forza_ws/race_stack/global_planner/install/global_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/global_planner/environment/pythonpath.sh"
