...
#include "global_planner/msg/detail/wpnt__rosidl_typesupport_fastrtps_c.h"
...
using _Wpnt__ros_msg_type = global_planner__msg__Wpnt;
...
static uint32_t _Wpnt__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_global_planner__msg__Wpnt(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = global_planner__msg__Wpnt;
    is_plain =
      (
...
static size_t _Wpnt__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_global_planner__msg__Wpnt(
