...
#include "global_planner/msg/detail/metadata__rosidl_typesupport_fastrtps_c.h"
...
using _Metadata__ros_msg_type = global_planner__msg__Metadata;
...
size_t get_serialized_size_global_planner__msg__Metadata(
  const void * untyped_ros_message,
...
static uint32_t _Metadata__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_global_planner__msg__Metadata(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_global_planner
size_t max_serialized_size_global_planner__msg__Metadata(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = global_planner__msg__Metadata;
    is_plain =
      (
...
static size_t _Metadata__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_global_planner__msg__Metadata(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, global_planner, msg, Metadata)() {
