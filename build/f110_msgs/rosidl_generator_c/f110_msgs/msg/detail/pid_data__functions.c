...
f110_msgs__msg__PidData__init(f110_msgs__msg__PidData * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    f110_msgs__msg__PidData__fini(msg);
    return false;
  }
  // should
  // actual
  ...
  f110_msgs__msg__PidData * output)
{
  ...
  // should
  output->should = input->should;
  // actual
  output->actual = input->actual;
  // error
...
f110_msgs__msg__PidData__create()
{
  ...
  f110_msgs__msg__PidData * msg = (f110_msgs__msg__PidData *)allocator.allocate(sizeof(f110_msgs__msg__PidData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(f110_msgs__msg__PidData));
  bool success = f110_msgs__msg__PidData__init(msg);
  if (!success) {
...
f110_msgs__msg__PidData__Sequence__init(f110_msgs__msg__PidData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  f110_msgs__msg__PidData * data = NULL;

  if (size) {
    data = (f110_msgs__msg__PidData *)allocator.zero_allocate(size, sizeof(f110_msgs__msg__PidData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = f110_msgs__msg__PidData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        f110_msgs__msg__PidData__fini(&data[i - 1]);
      }
...
f110_msgs__msg__PidData__Sequence__fini(f110_msgs__msg__PidData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      f110_msgs__msg__PidData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  f110_msgs__msg__PidData__Sequence * array = (f110_msgs__msg__PidData__Sequence *)allocator.allocate(sizeof(f110_msgs__msg__PidData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = f110_msgs__msg__PidData__Sequence__init(array, size);
  if (!success) {
...
f110_msgs__msg__PidData__Sequence__destroy(f110_msgs__msg__PidData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    f110_msgs__msg__PidData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
f110_msgs__msg__PidData__Sequence__are_equal(const f110_msgs__msg__PidData__Sequence * lhs, const f110_msgs__msg__PidData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!f110_msgs__msg__PidData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  f110_msgs__msg__PidData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(f110_msgs__msg__PidData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    f110_msgs__msg__PidData * data =
      (f110_msgs__msg__PidData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!f110_msgs__msg__PidData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          f110_msgs__msg__PidData__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!f110_msgs__msg__PidData__copy(
