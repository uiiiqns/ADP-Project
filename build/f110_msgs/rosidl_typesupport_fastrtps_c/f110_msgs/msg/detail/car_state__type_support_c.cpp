...
#include "f110_msgs/msg/detail/car_state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // slam_pose
#include "geometry_msgs/msg/detail/twist__functions.h"  // ekf_twist
...
using _CarState__ros_msg_type = f110_msgs__msg__CarState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: slam_pose
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->slam_pose, cdr))
    {
      return false;
    }
  }

  // Field name: ekf_twist
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
...
static uint32_t _CarState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_f110_msgs__msg__CarState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = f110_msgs__msg__CarState;
    is_plain =
      (
...
static size_t _CarState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_f110_msgs__msg__CarState(
