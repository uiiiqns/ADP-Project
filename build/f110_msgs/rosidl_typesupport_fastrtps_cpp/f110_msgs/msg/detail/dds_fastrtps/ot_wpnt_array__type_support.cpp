...
#include "f110_msgs/msg/detail/ot_wpnt_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const f110_msgs::msg::OTWpntArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.last_switch_time,
    cdr);
  // Member: side_switch
  cdr << (ros_message.side_switch ? true : false);
  // Member: ot_side
  cdr << ros_message.ot_side;
  // Member: ot_line
  cdr << ros_message.ot_line;
  // Member: wpnts
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  f110_msgs::msg::OTWpntArray & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_f110_msgs
max_serialized_size_OTWpntArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = f110_msgs::msg::OTWpntArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const f110_msgs::msg::OTWpntArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<f110_msgs::msg::OTWpntArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OTWpntArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const f110_msgs::msg::OTWpntArray *>(
...
static size_t _OTWpntArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OTWpntArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _OTWpntArray__callbacks = {
  "f110_msgs::msg",
  "OTWpntArray",
...
static rosidl_message_type_support_t _OTWpntArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OTWpntArray__callbacks,
...
{
  return &f110_msgs::msg::typesupport_fastrtps_cpp::_OTWpntArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, f110_msgs, msg, OTWpntArray)() {
  return &f110_msgs::msg::typesupport_fastrtps_cpp::_OTWpntArray__handle;
}
