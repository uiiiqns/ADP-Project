...
#include "f110_msgs/msg/detail/gap_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const f110_msgs::msg::GapData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  f110_msgs::msg::GapData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = f110_msgs::msg::GapData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const f110_msgs::msg::GapData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<f110_msgs::msg::GapData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GapData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const f110_msgs::msg::GapData *>(
...
static size_t _GapData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GapData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GapData__callbacks = {
  "f110_msgs::msg",
  "GapData",
...
static rosidl_message_type_support_t _GapData__handle = {
...
{
  return &f110_msgs::msg::typesupport_fastrtps_cpp::_GapData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, f110_msgs, msg, GapData)() {
  return &f110_msgs::msg::typesupport_fastrtps_cpp::_GapData__handle;
}
