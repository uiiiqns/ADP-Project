...
#include "f110_msgs/msg/detail/pid_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = f110_msgs::msg::PidData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const f110_msgs::msg::PidData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<f110_msgs::msg::PidData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PidData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const f110_msgs::msg::PidData *>(
...
static size_t _PidData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PidData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PidData__callbacks = {
  "f110_msgs::msg",
  "PidData",
...
static rosidl_message_type_support_t _PidData__handle = {
...
{
  return &f110_msgs::msg::typesupport_fastrtps_cpp::_PidData__handle;
}
