...
static const _OpponentTrajectory_type_support_symbol_names_t _OpponentTrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, f110_msgs, msg, OpponentTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, f110_msgs, msg, OpponentTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, f110_msgs, msg, OpponentTrajectory)() {
  return &::f110_msgs::msg::rosidl_typesupport_c::OpponentTrajectory_message_type_support_handle;
}
