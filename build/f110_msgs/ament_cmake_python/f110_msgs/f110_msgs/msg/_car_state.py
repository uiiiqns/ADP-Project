...
class CarState(metaclass=Metaclass_CarState):
    ...
    _fields_and_field_types = {
        'slam_pose': 'geometry_msgs/Pose',
        'ekf_twist': 'geometry_msgs/Twist',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Pose
        self.slam_pose = kwargs.get('slam_pose', Pose())
        from geometry_msgs.msg import Twist
        self.ekf_twist = kwargs.get('ekf_twist', Twist())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.slam_pose != other.slam_pose:
            return False
        if self.ekf_twist != other.ekf_twist:
            return False
        return True
    ...
    @builtins.property
    def slam_pose(self):
        """Message field 'slam_pose'."""
        return self._slam_pose

    @slam_pose.setter
    def slam_pose(self, value):
        if __debug__:
            from geometry_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'slam_pose' field must be a sub message of type 'Pose'"
        self._slam_pose = value

    @builtins.property
    def ekf_twist(self):
        """Message field 'ekf_twist'."""
        return self._ekf_twist

    @ekf_twist.setter
    def ekf_twist(self, value):
        if __debug__:
            from geometry_msgs.msg import Twist
            assert \
                isinstance(value, Twist), \
                "The 'ekf_twist' field must be a sub message of type 'Twist'"
        self._ekf_twist = value
