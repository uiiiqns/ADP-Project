...
{
  new (message_memory) f110_msgs::msg::CarState(_init);
}

void CarState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<f110_msgs::msg::CarState *>(message_memory);
  typed_message->~CarState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember CarState_message_member_array[2] = {
  {
    "slam_pose",  // name
    ...
    offsetof(f110_msgs::msg::CarState, slam_pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(f110_msgs::msg::CarState, ekf_twist),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::f110_msgs::msg::rosidl_typesupport_introspection_cpp::CarState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, f110_msgs, msg, CarState)() {
  return &::f110_msgs::msg::rosidl_typesupport_introspection_cpp::CarState_message_type_support_handle;
}
